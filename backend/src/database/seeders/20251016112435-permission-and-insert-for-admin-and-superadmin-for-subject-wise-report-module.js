...
export const up = async (queryInterface) => {
  ...
  let rolePermissionsForSuperAdmn = permissions.map((perm) => ({
  ...
  await queryInterface.bulkInsert("role_permissions", rolePermissionsForSuperAdmn, {});
